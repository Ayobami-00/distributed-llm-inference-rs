...
impl GgmlType for BlockQ4_0 {
    ...
    fn from_float(xs: &[f32], ys: &mut [Self]) {
        ...
        let qk = Self::BLCK_SIZE;
        let k = xs.len();
        debug_assert!(k.is_multiple_of_compat(qk), "{k} is not divisible by {qk}");
        debug_assert_eq!(
            ys.len(),
            k / qk,
            "size mismatch {} {} {}",
...
impl GgmlType for BlockQ4_1 {
    ...
    fn vec_dot_unopt(n: usize, xs: &[Self], ys: &[Self::VecDotType]) -> f32 {
        ...
        let qk = QK8_1;
        debug_assert!(
            n.is_multiple_of_compat(qk),
            "vec_dot_q4_1_q8_1: {n} is not divisible by {qk}"
        );
        debug_assert!(
            (n / qk).is_multiple_of_compat(2),
...
impl GgmlType for BlockQ8_0 {
    ...
    fn from_float(xs: &[f32], ys: &mut [Self]) {
        ...
        let k = xs.len();
        debug_assert!(
            k.is_multiple_of_compat(Self::BLCK_SIZE),
...
pub(crate) fn pack_to_q4kx8(blocks: &[BlockQ4K], n: usize) -> Vec<BlockQ4Kx8> {
    debug_assert!(n.is_multiple_of_compat(8));
